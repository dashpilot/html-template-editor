...
var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input, "class", "fileInput");
    			attr_dev(input, "accept", "image/png, image/jpeg, image/gif");
    			set_style(input, "display", "none");
    			add_location(input, file$1, 52, 0, 1472);
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	onMount(async () => {
    		document.body.addEventListener("click", function (e) {
    			...
    			if (el.tagName == "IMG" && !el.classList.contains("exclude")) {
    				window.cur_img = e.target;
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div1 = element("div");
    			span = element("span");
    			span.textContent = "Add Content Blocks";
    			t1 = space();
    			a = element("a");
    			a.textContent = "×";
    			t3 = space();
    		...
    		i: function intro(local) {
    			...
    			add_render_callback(() => {
    				if (!div1_transition) div1_transition = create_bidirectional_transition(div1, fly, { x: -320 }, true);
    		...
    		o: function outro(local) {
    			if (!div1_transition) div1_transition = create_bidirectional_transition(div1, fly, { x: -320 }, false);
    ...
    function create_each_block(ctx) {
    	...
    	function click_handler_3() {
    		return /*click_handler_3*/ ctx[7](/*item*/ ctx[10]);
    	}
    ...
    function create_fragment(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let if_block0 = /*showAdd*/ ctx[0] && create_if_block_1(ctx);
    	let if_block1 = /*showSet*/ ctx[1] && create_if_block(ctx);
    	image = new Image_1({ $$inline: true });
    	...
    	const block = {
    		c: function create() {
    			...
    			if (script.src !== (script_src_value = "https://unpkg.com/@deckdeckgo/inline-editor@latest/dist/deckdeckgo-inline-editor/deckdeckgo-inline-editor.esm.js")) attr_dev(script, "src", script_src_value);
    			add_location(script, file, 1, 0, 14);
    			if (img0.src !== (img0_src_value = "/img/add.png")) attr_dev(img0, "src", img0_src_value);
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const click_handler = () => $$invalidate(0, showAdd = true);
    	const click_handler_1 = () => $$invalidate(1, showSet = true);
    	const click_handler_2 = () => $$invalidate(0, showAdd = false);
    	const click_handler_3 = item => addItem(item.id);
    	const click_handler_4 = () => $$invalidate(1, showSet = false);
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("showSet" in $$props) $$invalidate(1, showSet = $$props.showSet);
